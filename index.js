...
console.log("Gorev 1A:", MenuElemaniOlustur("Cheeseburger", 8, "Burgerler"));
...
console.log("Gorev 1B:", MenuElemaniOlustur("Karışık Pizza", 5, "Pizzalar"));
...
console.log("Gorev 2:", burger.indirim("öğretmen"));
console.log("Gorev 2:", burger.indirim("öğrenci"));
console.log("Gorev 2:", burger.indirim("diger"));
...
console.log("Gorev 3:", degerlendirmeler[5].geribildirim);
...
console.log("Gorev 4:", degerlendirmeler[7].geribildirim);
/*  Görev 5: 
...
function DegerlendirmeEkle(arr, isim, puan, yorum) {
	arr[8] = {
		isim: isim,
		puan: puan,
		geribildirim: yorum,
...
function AnahtardanDegerlendirmeAl(arr, index) {
	let string = `${arr[index].isim} isimli kişi ${arr[index].puan} puan verdi ve şunları yazdı: ${arr[index].geribildirim}`;
	return string;
}
...
function SonDegerlendirmeyiAl(arr) {
	let string = `${arr[arr.length - 1].isim} isimli kişi ${
		arr[arr.length - 1].puan
	} puan verdi ve şunları yazdı: ${arr[arr.length - 1].geribildirim}`;
	return string;
}
...
function UzunDegerlendirmeleriAl() {
	/* Kodlar buraya */
}
